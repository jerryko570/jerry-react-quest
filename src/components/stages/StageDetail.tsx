  ...
  return (
    <Section padding='md' maxWidth='max-w-3xl'>
      <nav className='mb-8 flex flex-wrap items-center gap-1.5 text-sm text-gray-500'>
        ...
        <span>/</span>
        <Link href={`/?tab=${stage.category}`} className='hover:text-blue-500'>
      ...
      <div className='mt-10'>
        ...
        <div className='mt-10 flex justify-center'>
          <Link
            ...
            className='inline-flex items-center gap-2 rounded-full border-2 border-gray-200 bg-white px-6 py-3 text-sm font-semibold text-gray-700 transition hover:-translate-y-0.5 hover:border-blue-500 hover:text-blue-500'
          >
